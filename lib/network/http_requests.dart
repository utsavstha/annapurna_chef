...
import 'package:annapurna_chef/utils/exceptions.dart';
...
class HttpNetworkRequest {
  ...
  static final HttpNetworkRequest _httpRequest = HttpNetworkRequest._internal();
  late Dio dio;
  factory HttpNetworkRequest() {
    return _httpRequest;
  }

  HttpNetworkRequest._internal() {
    dio = Dio();
  }
  // Handles get request
